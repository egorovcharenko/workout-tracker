...
const STRENGTH_STANDARDS = {
  ...
  "Dumbbell Lateral Raises": { beg: 9, nov: 20, int: 36, adv: 56, elite: 80 },
  "Incline DB Curls": { beg: 16, nov: 28, int: 46, adv: 67, elite: 91 },
  "Dumbbell Flat Bench Press": { beg: 40, nov: 64, int: 94, adv: 130, elite: 170 },
  "Barbell Bench Press": { beg: 99, nov: 167, int: 221, adv: 290, elite: 367 },
  "Single-Arm Dumbbell Rows": { beg: 42, nov: 67, int: 99, adv: 138, elite: 180 },
  "Dumbbell Bent-Over Rows": { beg: 36, nov: 57, int: 81, adv: 111, elite: 144 },
  "Overhead Dumbbell Press": { beg: 33, nov: 51, int: 73, adv: 100, elite: 129 },
  "Seated Overhead Press": { beg: 33, nov: 51, int: 73, adv: 100, elite: 129 },
  "Goblet Squat": { beg: 34, nov: 61, int: 95, adv: 144, elite: 195 },
  "Bulgarian Split Squat": { beg: 22, nov: 40, int: 65, adv: 97, elite: 132 },
  "Dumbbell Romanian Deadlift": { beg: 27, nov: 53, int: 90, adv: 135, elite: 188 },
  "Single-Leg DB RDL": { beg: 19, nov: 59, int: 125, adv: 216, elite: 325 },
  "Dumbbell Bicep Curls": { beg: 16, nov: 32, int: 54, adv: 83, elite: 115 },
  "Dumbbell Hammer Curls": { beg: 22, nov: 36, int: 54, adv: 76, elite: 101 },
  ...
  "Incline Dumbbell Press": { beg: 48, nov: 67, int: 90, adv: 117, elite: 146 },
  ...
  "Reverse Flyes": { beg: 6, nov: 20, int: 41, adv: 71, elite: 107 },
  "Overhead Tricep Extension": { beg: 20, nov: 35, int: 55, adv: 87, elite: 120 },
  "Lunges": { beg: 21, nov: 42, int: 70, adv: 107, elite: 149 },
  "Calf Raises": { beg: 20, nov: 44, int: 85, adv: 139, elite: 202 },
  "Band Torso Rotation": { beg: 15, nov: 28, int: 42, adv: 58, elite: 76 },
  "Hanging Knee Raise": { beg: 20, nov: 40, int: 65, adv: 90, elite: 115 },
  "Dumbbell Shrugs": { beg: 38, nov: 67, int: 106, adv: 154, elite: 208 },
