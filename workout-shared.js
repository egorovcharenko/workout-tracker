...
const WORKOUTS = [
  ...
  //    B/A/B next week); micro days slot into Tue/Thu and can shuffle freely.
  {
    ...
    exercises: [
      { name: "Barbell Back Squat", sets: 3, warmups: 3, reps: "5-8", notes: "Bar on upper back. Set the rack safety pins at the bottom of your range so you can bail a missed rep. Brace, sit between your hips, drive up. Ramp the warm-up sets.", equipment: "barbell", rest: 180 },
      ...
      { name: "Assisted Pull-Ups", sets: 4, reps: "5-8", notes: "Volume day: band that lets you get 5-8 clean reps. Chin over bar, controlled descent.", video: "https://www.youtube.com/shorts/0sRmDbT9Pm0", equipment: "band", assist: true, grips: ['neutral', 'chinup', 'pullup'], rest: 120, noWarmup: true },
  ...
  {
    id: "micro-arms",
    name: "Micro: Arms & Core",
    program: true,
    kind: "micro",
    duration: "~15 min",
    rest: 60,
    warmup: "One light feel set if anything is stiff",
    exercises: [
      { name: "Dumbbell Hammer Curls", sets: 3, reps: "8-12", video: "https://www.youtube.com/shorts/0IAJqSwFnHI", notes: "Hammer grip default · toggle for variants", grips: ['hammer', 'supinated', 'reverse'], rest: 60, noWarmup: true },
      { name: "Dumbbell Bicep Curls", sets: 3, reps: "8-12", notes: "Supinated (palms up) default · toggle for variants", video: "https://www.youtube.com/shorts/MKWBV29S6c0", grips: ['supinated', 'hammer', 'reverse'], rest: 60, noWarmup: true },
      { name: "Band Tricep Pushdowns", sets: 3, reps: "10-15", equipment: "band", video: "https://www.youtube.com/shorts/eGjSphOefTI", notes: "Elbows glued to ribs, squeeze at bottom", rest: 60, noWarmup: true },
      { name: "Band Torso Rotation", sets: 2, reps: "10-12", notes: "Anchor band at chest height, rotate left and right under control. 10-12 per side.", equipment: "band", rest: 60, noWarmup: true },
    ],
  },
  {
    id: "main-b",
    ...
    exercises: [
      { name: "Barbell Deadlift", sets: 3, warmups: 3, reps: "5-8", notes: "Ramp up across the warm-up sets. Flat back, brace, push the floor away. Reset each rep — don't bounce.", equipment: "barbell", rest: 180 },
      { name: "Incline Barbell Press", sets: 4, warmups: 1, reps: "6-10", notes: "Bench at ~30°. Lower the bar under control to your upper chest, press up and slightly back.", equipment: "barbell", rest: 120 },
      { name: "Bent-Over Barbell Rows", sets: 4, warmups: 1, reps: "8-12", notes: "Keep back flat, hinge at hips, pull bar to lower chest.", equipment: "barbell", rest: 120 },
      { name: "Assisted Pull-Ups", sets: 3, reps: "3-5", notes: "Heavy day: lightest band that allows 3-5 strict reps — or do slow negatives.", video: "https://www.youtube.com/shorts/0sRmDbT9Pm0", equipment: "band", assist: true, grips: ['neutral', 'chinup', 'pullup'], rest: 150, noWarmup: true },
    ],
  },
  {
    id: "micro-delts",
    name: "Micro: Delts & Traps",
    program: true,
    kind: "micro",
    duration: "~15 min",
    rest: 60,
    warmup: "A few band pull-aparts to wake up the rear delts",
    exercises: [
      { name: "Dumbbell Shrugs", sets: 3, reps: "10-15", notes: "Heavy DBs at your sides, shrug straight up, pause at the top, lower slow.", rest: 60, noWarmup: true },
      { name: "Face Pulls", sets: 3, reps: "12-15", equipment: "band", notes: "Anchor band at face height, pull toward your face, elbows high, squeeze the rear delts.", rest: 60, noWarmup: true },
      { name: "Reverse Flyes", sets: 3, reps: "12-15", notes: "Rear delts & upper back, light weight, squeeze at the top", video: "https://www.youtube.com/shorts/LsT-bR_zxLo", rest: 60, noWarmup: true },
      { name: "Dead Hang + Scap Pulls", sets: 2, reps: "5-8", notes: "Dead hang 20-40s, then 5-8 scap pulls: shrug shoulder blades down and back without bending the elbows.", rest: 60, noWarmup: true },
    ],
  },
  {
    id: "weekend-extras",
